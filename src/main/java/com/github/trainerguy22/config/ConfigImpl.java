...
public abstract class ConfigImpl extends Config {
    ...
    public Map<String, Object> getGroup(String group) {
        return group == null ? ImmutableMap.copyOf(config) : (config.get(group) instanceof Map ? ((Map<String, Object>) config.get(group)) : null);
    }
